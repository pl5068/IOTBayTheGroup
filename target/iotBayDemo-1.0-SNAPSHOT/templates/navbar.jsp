...
<nav class="flex items-center justify-center p-4 px-6">
    <div class="flex w-full items-center">
        ...
        <div class="flex justify-end gap-2">
            ...
            <a href="Cart">
                <div id="cartButton" class="flex flex-shrink-0 items-center justify-center gap-2 rounded-full bg-white px-3 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-50">
